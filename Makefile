...
ACLOCAL = ${SHELL} /var/tmp/openvpn-2.1.1/missing --run aclocal-1.10
AMTAR = ${SHELL} /var/tmp/openvpn-2.1.1/missing --run tar
AUTOCONF = ${SHELL} /var/tmp/openvpn-2.1.1/missing --run autoconf
AUTOHEADER = ${SHELL} /var/tmp/openvpn-2.1.1/missing --run autoheader
AUTOMAKE = ${SHELL} /var/tmp/openvpn-2.1.1/missing --run automake-1.10
AWK = gawk
CC = gcc
...
EXEEXT = 
GREP = /bin/grep
IFCONFIG = /system/xbin/bb/ifconfig
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /var/tmp/openvpn-2.1.1/missing --run makeinfo
MAN2HTML = 
...
VERSION = 2.1.1
abs_builddir = /var/tmp/openvpn-2.1.1
abs_srcdir = /var/tmp/openvpn-2.1.1
abs_top_builddir = /var/tmp/openvpn-2.1.1
abs_top_srcdir = /var/tmp/openvpn-2.1.1
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = $(SHELL) /var/tmp/openvpn-2.1.1/install-sh
